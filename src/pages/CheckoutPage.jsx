        ...
        <div className="bg-white-berry dark:bg-black-pearl min-h-screen transition-colors duration-500">
            ...
            <main className="relative ml-64 transition-colors duration-500 min-h-screen bg-[#EFEFEF] dark:bg-black-pearl-light p-8 lg:p-16">
                <div className="absolute top-8 right-8 z-[60] flex items-center gap-4">
                    ...
                    <button
                        onClick={toggleTheme}
                        className="p-3 flex items-center justify-center bg-timberwolf/40 dark:bg-walnut/40 backdrop-blur-md hover:bg-timberwolf/60 dark:hover:bg-walnut/60 text-black-pearl dark:text-rose-fog rounded-full transition-all border border-black-pearl/10 dark:border-rose-fog/10 shadow-lg group focus:outline-none"
