...
const ORDERS_DATA = [
  { id: "#VH-9921", name: "Julianna Vane", date: "Oct 24, 2023", total: "$124.50", status: "Paid", statusClass: "bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-400 dark:border-green-400/20" },
  { id: "#VH-9920", name: "Marcus Thorne", date: "Oct 24, 2023", total: "$89.00", status: "Pending", statusClass: "bg-amber-100 text-amber-700 border-amber-200" },
  { id: "#VH-9919", name: "Evelyn Reed", date: "Oct 23, 2023", total: "$210.30", status: "Shipped", statusClass: "bg-blue-100 text-blue-700 border-blue-200 dark:bg-blue-900/40 dark:text-blue-400 dark:border-blue-400/20" },
  { id: "#VH-9918", name: "Silas Blackwood", date: "Oct 23, 2023", total: "$45.00", status: "Paid", statusClass: "bg-green-100 text-green-700 border-green-200 dark:bg-green-900/40 dark:text-green-400 dark:border-green-400/20" },
  { id: "#VH-9917", name: "Clarissa Bloom", date: "Oct 22, 2023", total: "$315.00", status: "Pending", statusClass: "bg-amber-100 text-amber-700 border-amber-200" },
    ...
    <div className="min-h-screen bg-[#E1E5F0] text-[#0B1B2A] dark:bg-black-pearl dark:text-rose-fog">
      ...
      <main className="ml-72 transition-all duration-300 min-h-screen p-8 lg:p-12 relative" id="main-content">
        <header className="flex justify-between items-center mb-12">
          <div>
            <h1 className="serif-font text-5xl font-bold text-[#0B1B2A] dark:text-rose-fog">Orders</h1>
            <p className="small-caps text-[10px] tracking-widest uppercase mt-1 text-[#0B1B2A]/60 dark:text-rose-fog/60">ADMIN TERMINAL</p>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 border-l border-black/10 dark:border-walnut pl-6">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-[#0B1B2A] dark:text-rose-fog">Alex Rivers</p>
                <p className="text-[10px] text-[#0B1B2A]/40 dark:text-rose-fog/40 uppercase tracking-tighter">Store Manager</p>
              </div>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          {["All Orders", "Pending", "Shipped", "Cancelled"].map((status) => (
            <button
              key={status}
              onClick={() => setFilterStatus(status)}
              className={`px-6 py-2 rounded-full border text-sm font-medium transition-all ${filterStatus === status
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr className="border-b border-black/10 dark:border-rose-fog/10">
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Order ID</th>
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Customer Name</th>
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Date</th>
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Total Amount</th>
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Status</th>
                  <th className="px-8 py-6 text-[11px] font-bold uppercase tracking-[0.2em] text-[#0B1B2A]/50 dark:text-rose-fog/50">Actions</th>
                </tr>
              </thead>
